...
function App(conf) {
  conf = {
    ...
    light1Color: 0x0637ff,
    light2Color: 0x3683f7,
    light3Color: 0xff8200,
    light4Color: 0x2a65eb,
    ...conf
  };
...
//   const heightInput = document.getElementById('heightInput');
  const headerContainer = document.getElementById('customHeader');
  ...
  function animate() {
    ...
    renderer.setClearColor( 0xc0cbef, 0.1 );
  ...
  function updateSize() {
    width = headerContainer.offsetWidth; cx = width / 2;
    height = headerContainer.offsetHeight; cy = height / 2;
    if (renderer && camera) {
